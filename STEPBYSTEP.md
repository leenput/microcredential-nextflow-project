...
This module will contain a bash script that will parse the output files generated by nanoplot and samtools depth to evaluate if the sample is suitable for downstream analyses.
...
- include ubuntu as container image and conda env
- as input, use tuple of all values (sample,)
